...
**KDE to estimate the concentration of bear occurrences based on elevation values. The elevation data for bear locations ranges from a minimum of 11.68 to a maximum of 2308.18, with most occurrences concentrated between 461.09 and 937.91  The mean elevation is 754.84, slightly higher than the median, indicating a skew towards higher elevations.**
